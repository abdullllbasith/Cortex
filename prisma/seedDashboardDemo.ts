...
import { refreshDemoSalesWindow } from '../src/lib/seed/refreshDemoSalesWindow'
...
export async function seedDashboardDemoData(
  ...
  if (salesRefresh.refreshed) {
    console.log(
      `  ✓ Demo sales window refreshed (+${salesRefresh.shiftedDays}d, ${salesRefresh.salesEvents} events)`,
    )
  } else {
    console.log('  ✓ Demo sales window already current')
  }
