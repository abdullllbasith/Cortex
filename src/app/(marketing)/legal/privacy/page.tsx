...
export const metadata: Metadata = {
  ...
  description: 'How SAIOS uses cookies and handles your data.',
}
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 text-slate-700 dark:text-slate-300">
      ...
      <p className="mt-4 text-sm leading-relaxed">
        SAIOS uses essential cookies to authenticate your session and keep the application secure. These are required
      ...
      <p className="mt-2 text-sm leading-relaxed">
        ...
        administrator or Softora support.
      </p>
    </main>
  )
}
