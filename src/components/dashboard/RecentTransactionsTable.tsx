...
import type { ExecutiveData, Transaction } from './types'
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                'h-8 w-48 rounded-md border border-slate-200 bg-slate-50 pl-8 pr-3 text-xs',
                  ...
                  <tr key={i}>
                    {Array.from({ length: 6 }).map((__, j) => (
                      <td key={j} className="px-4 py-3">
                        <Skeleton height="12px" className="rounded" />
                      </td>
                    ))}
                  </tr>
                ))
              : filtered.map((txn) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 font-display text-sm font-semibold tabular-nums text-slate-900 dark:text-slate-100">
