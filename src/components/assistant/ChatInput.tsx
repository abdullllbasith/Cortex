...
export function ChatInput({
  ...
  onTyping,
  disabled = false,
  placeholder = 'Ask SAIOS anything about your business…',
}: ChatInputProps) {
  ...
  return (
    <div className="border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4">
      <div className="max-w-4xl mx-auto">
        <div
          className={cn(
            'chat-input-shell flex items-end gap-1 rounded-xl border border-slate-200 dark:border-slate-700 p-1.5',
        ...
        >
          <textarea
            ...
            rows={1}
            className={cn(
              'chat-input-field flex-1 min-w-0 resize-none border-0 bg-transparent px-3 py-2.5',
              'min-h-[40px] max-h-[160px] overflow-hidden',
              'text-sm leading-5 text-slate-900 dark:text-slate-100 placeholder:text-slate-400',
