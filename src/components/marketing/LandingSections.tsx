...
export function HeroSection() {
  return (
    <section className="relative -mt-[4.75rem] h-[calc(100svh+4.75rem)] max-h-[calc(100svh+4.75rem)] overflow-hidden md:-mt-[5.5rem] md:h-[calc(100svh+5.5rem)] md:max-h-[calc(100svh+5.5rem)]">
      <MarketingHeroBackdrop />

      <div className="absolute inset-x-0 top-[4.75rem] flex h-[100svh] items-center justify-center px-6 md:top-[5.5rem]">
        <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
          <div className="flex max-w-fit items-center gap-2 rounded-full border border-[#5BA8A0]/30 bg-[#5BA8A0]/10 px-4 py-1.5">
          ...
          <h1 className="mt-6 font-display text-4xl font-bold tracking-tight text-[#1E2D3D] sm:text-5xl lg:text-[64px] lg:leading-[1.1] dark:text-white">
          ...
          <p className="mt-6 text-lg leading-relaxed text-[#1E2D3D]/60 dark:text-white/60">
            Cortex is an enterprise AI operating system — unifying intelligence, automation,
...
export function HeroDashboardSection() {
  return (
    <section id="preview" className="relative scroll-mt-24 bg-[#F7FAFA] px-6 py-16 dark:bg-[#0a1520] md:py-20">
...
const STEPS = [
  {
    ...
    description:
      'Plug in your existing tools — CRM, ERP, spreadsheets, databases. Cortex syncs everything in minutes with zero-code connectors.',
  ...
  },
  {
    ...
    detail: 'Powered by Cortex proprietary AI.',
  },
  {
    step: '03',
    ...
    <section className="relative border-t border-[#1E2D3D]/8 px-6 py-24 dark:border-white/8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-[#1E2D3D]/60 dark:text-white/50">
            Connect the tools you already use. Cortex becomes the intelligent layer across all of them.
          </p>
        </div>
...
const TESTIMONIALS = [
  {
    quote:
      "Cortex replaced five separate tools and an analyst role. Our team now gets answers in seconds that used to take days of report pulling.",
    author: 'Priya Ramesh',
  ...
  {
    quote:
      "Finally, a product that speaks business — not engineering. Every team member uses Cortex daily, from sales to finance to HR.",
    ...
    <section className="relative border-t border-[#1E2D3D]/8 px-6 py-24 dark:border-white/8">
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-[#1E2D3D]/60 dark:text-white/50">
            Real results from businesses running smarter with Cortex.
          </p>
        </div>
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-white/50">
            Your data never trains our models. Cortex is built for the enterprise with compliance and
    ...
    <section className="relative overflow-hidden px-6 py-24">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white/75">
          Join 500+ businesses already using Cortex to automate operations,
