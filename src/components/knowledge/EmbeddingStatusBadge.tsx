...
type EmbeddingStatus = 'PENDING' | 'INDEXED' | 'ERROR'
...
const config: Record<EmbeddingStatus, { label: string; className: string }> = {
  ...
  INDEXED: { label: 'Indexed', className: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-400' },
  ERROR:   { label: 'Error',   className: 'bg-red-50 text-red-700 dark:bg-red-950/40 dark:text-red-400' },
}
