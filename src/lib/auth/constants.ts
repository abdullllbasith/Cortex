...
export const WORKFLOW_TEMPLATES = [
  ...
  },
  {
    ...
    description: 'Sends payment reminders and escalates overdue invoices to your finance team.',
    industries: ['Professional Services', 'Technology & SaaS', 'Financial Services', 'Other'],
  },
  {
    id: 'new-lead-nurture',
    name: 'New Lead Nurture',
    description: 'Welcome series with conditional sales assignment for inbound leads.',
    industries: ['Technology & SaaS', 'Real Estate', 'Professional Services', 'Other'],
  },
  {
    id: 'order-to-cash',
    name: 'Order to Cash',
    description: 'End-to-end order delivery, invoicing, and payment collection automation.',
    industries: ['Retail & E-commerce', 'Manufacturing', 'Logistics & Supply Chain', 'Other'],
  },
  {
    id: 'lead-to-deal',
    name: 'Lead to Deal',
    description: 'Nurture new CRM leads through tasks, offers, and re-engagement.',
    industries: ['Technology & SaaS', 'Professional Services', 'Real Estate', 'Other'],
  },
  {
    id: 'employee-onboarding-v2',
    name: 'Employee Onboarding',
    description: 'Full new-hire setup with accounts, leave, and manager checklist.',
    industries: ['Technology & SaaS', 'Professional Services', 'Healthcare', 'Other'],
  },
] as const
