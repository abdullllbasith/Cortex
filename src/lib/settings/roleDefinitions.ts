...
export const DEFAULT_INVITE_MESSAGE =
  "You've been invited to join our workspace on SAIOS. Click the link below to accept your invitation and set up your account."
...
export function buildInviteEmailPreview(opts: {
  ...
  return `Subject: Join ${opts.tenantName} on SAIOS
