...
We received a request to reset your SAIOS password.
...
— SAIOS`
  ...
  const html = `
    <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;color:#0f172a">
      ...
      <p style="color:#475569;line-height:1.6">We received a request to reset your SAIOS account password. Click the button below to choose a new password. This link expires in about one hour.</p>
  ...
  await sendMail({
    to: opts.to,
    subject: 'Reset your SAIOS password',
    text,
    html,
    fromName: process.env.SMTP_FROM_NAME ?? 'SAIOS',
  })
